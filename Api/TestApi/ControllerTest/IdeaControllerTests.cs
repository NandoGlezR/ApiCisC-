...
namespace TestApi.ControllerTest
{
    ...
    public class IdeaControllerTests
    {
        ...
        private Mock<IRepositoryAsync<Vote, string>> _mockVoteRepository;
        ...
        public void SetUp()
        {
            ...
            _mockVoteRepository = new Mock<IRepositoryAsync<Vote, string>>();
            ...
            _controller = new IdeaController(_mockIdeaService.Object, _mockVoteService.Object,
        ...
        public async Task DeleteVote_ShouldReturnOkResult_WhenVoteIsDeleted()
        {
            ...
            _mockVoteRepository
                .Setup(repo => repo.FindByIdAsync(ideaId, userId))
