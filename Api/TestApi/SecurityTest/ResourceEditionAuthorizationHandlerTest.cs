...
[TestFixture]
public class ResourceEditionAuthorizationHandlerTest
{
    private ResourceEditionAuthorizationHandler _handler;
    private EditionRequirement _requirement;
    ...
    public void SetUp()
    {
        _handler = new ResourceEditionAuthorizationHandler();
        _requirement = new EditionRequirement();
