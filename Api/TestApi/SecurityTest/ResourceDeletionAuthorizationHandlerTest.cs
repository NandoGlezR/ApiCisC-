...
[TestFixture]
public class ResourceDeletionAuthorizationHandlerTest
{
    private ResourceDeletionAuthorizationHandler _handler;
    private DeletionRequirement _requirement;
    ...
    public void SetUp()
    {
        _handler = new ResourceDeletionAuthorizationHandler();
        _requirement = new DeletionRequirement();
    ...
    public async Task HandleRequirementAsync_ShouldFail_WhenUserIdDoesNotMatch()
    {
        ...
        Assert.That(authorizationContext.HasFailed, Is.True);
    }
}